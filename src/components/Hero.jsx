...
const Hero = () => {
    ...
    return(
        ...
        <div className="md:w-1/2 text-center md:text-left px-24 md:px-0 h-600 flex flex-col justify-center p-4 ">
        <h2 className='text-gray-500 uppercase tracking-[0.75em]'>New product</h2>
        <h1 className='text-6xl uppercase text-white py-8'>XX99 MARK II Headphones</h1>
