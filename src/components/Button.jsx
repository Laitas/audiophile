...
const Button = ({v, text, onClick}) => {
    switch(v){
        ...
        case 2:
        return <span onClick={onClick} className='cursor-pointer text-center uppercase bg-transparent border border-black hover:bg-black hover:text-white transition-all duration-300 p-4 text-black font-bold text-sm tracking-wide'>{text}</span>
        case '2inverse':
