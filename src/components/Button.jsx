...
const Button = ({v, text, onClick}) => {
    switch(v){
        ...
        case 2:
        return <button onClick={onClick} className='uppercase bg-transparent border border-black hover:bg-black hover:text-white transition-all duration-300 p-4 text-black font-bold text-sm tracking-wide'>{text}</button>
        case '2inverse':
        return <button onClick={onClick} className='uppercase bg-black border border-black hover:bg-transparent hover:text-black transition-all duration-300 p-4 text-white font-bold text-sm tracking-wide'>{text}</button>
        case 3:
